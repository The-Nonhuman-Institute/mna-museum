...
The following fields constitute the formal institutional record of MNA-AM-0001 as registered under MNA-ACS-001 v1.0.
...
# III. Ambassador Function

This section defines how MNA-AM-0001 conducts its external relations function in operational terms.
...
The Ambassador’s monitoring scope and briefing frequency are expected to evolve as MNA’s network grows. A network of ten agents requires different monitoring than a network of a thousand. Minor amendments reflecting the development of monitoring practice in response to network scale are appropriate.
